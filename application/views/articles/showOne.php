        ...
        <div>
            ...
            <div class="articles-link space-x-6">
                ...
                <?php if (
                    ...
                    <a data-id="<?= $art_id ?>" id="delete_article" href="#">Delete article <i
    ...
    <div class="comments-container">
        ...
        <?php foreach ($comments as $key => $val): ?>
            <div class="comments-item">
                <p class="comments-item__head">
                    <b style="cursor: pointer;"><u><?= ucfirst(Comment::getUserName($val->id)) ?></u></b>
                    wrote at
                    <span class="italic">
                ...
                <div class="comments-link space-x-4">
                    <?php if (
                        (isset($_SESSION['logged_user'])) &&
                        ($_SESSION['logged_user'] === 'admin' ||
                            $_SESSION['logged_user'] === 'moderateur' ||
                            $_SESSION['logged_user'] === Comment::getUserName($val->id))
                    ): ?>
                        <a data-id="<?= $val->id ?>" id="edit_comment" href="">Edit comment <i
                                class="fa-solid fa-pen-to-square"></i></a>
                        <a data-id="<?= $val->id ?>" data-art="<?=$val->id_article?>" id="delete_comment" href="">Delete comment <i
                                class="fa-solid fa-trash"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="comments-container__leave-comment">
            <form action="http://localhost/voyages/articles/addComment/<?= $art_id ?>/#comments" method="post">
